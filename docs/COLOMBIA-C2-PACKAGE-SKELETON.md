...
`0.1.3` preserves this offline skeleton and the C4B1/C4B2/C4B3 pure contracts. No
...
Package `0.1.3` now verifies fifteen payload hashes against that current closed
